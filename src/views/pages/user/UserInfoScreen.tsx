    ...
    return (
        <ScrollView style={userInfoStyles.container}>
            ...
            <View style={userInfoStyles.header}>
                ...
                <Image
                    source={user?.urlImage ? { uri: user?.urlImage } : DefaultAvatar}
                    style={userInfoStyles.avatar}
                />
            </View>

            <View style={userInfoStyles.infoContainer}>
                <InfoRow label="Họ và tên" value={user?.staff?.name || user?.userName || ""} />
                <InfoRow label="Số điện thoại" value={user?.phone || ""}/>
                <InfoRow label="Giới tính" value={user?.gender === 1 ? "Nam" : "Nữ"} />
                <InfoRow
                    label="Đối tác Glow"
            ...
            <View style={userInfoStyles.buttonContainer}>
                ...
                <TouchableOpacity style={userInfoStyles.editButton}>
...
export function InfoRow(props: { label?: string; value?: string; isLink?: boolean }) {
    return (
